...
model = YOLO(r'D:\yolo_models\yolov8m.pt')
#model.to('cuda')


'''define codec'''
vid_path = r"D:\BeamNG_dataset\Crash_8\etk800-LegranSE\47-53.mp4"
cap = cv.VideoCapture(vid_path)

# fourcc = cv.VideoWriter_fourcc(*'mp4v')
# out = cv.VideoWriter(r'E:\01_Programming\Py\Masterarbeit_BeamNG\data_extract\extract_2\polygon_test_crash_SC4.mp4', fourcc, 30.0, (854, 480))
...
while cap.isOpened():
    ...
    result = model.track(frame, persist=True, save=False, tracker='bytetrack.yaml', conf=0.3, device='cuda')
